...
export const metadata: Metadata = {
  title: {
    template: "%s – Hire-Wise",
    default: "Hire-Wise – Navigate your future, one answer at a time",
  },
  description:
    "Practice interviews with an AI voice assistant. Get personalized feedback, improve your skills, and ace your next job interview with Hire-Wise.",
  keywords:
  ...
  openGraph: {
    ...
    title: "Hire-Wise | AI-Powered Interview Preparation",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hire-Wise Interview Preparation Platform",
      },
    ],
  },
  twitter: {
